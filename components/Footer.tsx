      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8 mb-6 sm:mb-8">
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="bg-primary text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-bold text-lg sm:text-xl inline-block mb-3 sm:mb-4">
              BRSATS
            </div>
            ...
            <div className="mt-3 sm:mt-4">
              <a 
                ...
                className="inline-flex items-center space-x-2 text-green-400 hover:text-green-300 font-semibold text-sm sm:text-base"
              >
          ...
          <div>
            ...
            <div className="space-y-1.5 sm:space-y-2 text-gray-400 text-xs sm:text-sm">
              <p className="font-medium text-white text-sm sm:text-base">African Transport Systems</p>
              <p>Numéro 15, Boulevard du 30 juin</p>
              <p>Commune de GOMBE, Kinshasa</p>
              <p className="mt-2">
                <a href="tel:+243819929881" className="hover:text-white">+243 819 929 881</a>
              </p>
              <p>
                <a href="mailto:contact@ats-handling-rdc.com" className="hover:text-white break-all">
                  contact@ats-handling-rdc.com
                </a>
              </p>
              <p className="mt-2">
                <a href="https://www.ats-handling-rdc.com" target="_blank" rel="noopener noreferrer" className="hover:text-white break-all">
          ...
          <div>
            <h4 className="font-semibold mb-3 sm:mb-4 text-sm sm:text-base">{t.footer.technicalSupport}</h4>
            <div className="space-y-1.5 sm:space-y-2 text-gray-400 text-xs sm:text-sm">
              <p className="font-medium text-white text-sm sm:text-base">BRSATS</p>
              <p>
                <a href="mailto:support@brsats.com" className="hover:text-white flex items-center space-x-2 break-all">
              ...
              <p>
                <a href="mailto:contact@brsats.com" className="hover:text-white flex items-center space-x-2 break-all">
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
              ...
              <p className="mt-2">
                <a href="https://www.brsats.com" target="_blank" rel="noopener noreferrer" className="hover:text-white break-all">
                  www.brsats.com
                </a>
              </p>
            </div>
          ...
          <div>
            <h4 className="font-semibold mb-3 sm:mb-4 text-sm sm:text-base">{t.footer.airports}</h4>
